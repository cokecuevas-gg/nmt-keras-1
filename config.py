def load_parameters():
    ...
    SRCS_LAN = ['en']
    TRGS_LAN = ['fr','es']                                 # Language of the target text.
    MULTILANGUAGE = 1
    ...
    MAX_INPUT_TEXT_LEN = 10                       # Maximum length of the input sequence
    ...
    SOURCE_TEXT_EMBEDDING_SIZE = 60              # Source language word embedding size.
    ...
    TARGET_TEXT_EMBEDDING_SIZE = 60              # Source language word embedding size.
